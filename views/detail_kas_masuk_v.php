...
<div class="container">
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="<?php echo site_url('kas_masuk')?>"><?php echo $data_ar_header->vcARHeaderCode?></a>
            </div>
            <br>
            <br>
        </div>
...
<div class="text-right" style="margin-right:2%;">
    ...
    if($data_ar_header->itPostARHeader == '1'){
        ?>
        <button disabled="disabled" type="button" class="btn btn-danger">Tambah</button>
        <?php
    }else{
        ?>
        ...
        <tbody>
            ...
            foreach ($detail_header as $detail) {
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $detail->vcARItemDesc?></td>
                    ...
                    <td class="text-center">
                        ...
                        if ($data_ar_header->itPostARHeader == '1'){
                            ...
                            <a title="Hapus" href="<?php echo site_url('kas_masuk/delete_ar_item/').'/'.$detail->IDItem.'/'.$detail->cuARItemValue.'/'.$detail->vcARHeaderCode;?>" class="btn-sm btn-danger" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fa fa-trash-o"></i></a>
                            <?php
                        }
                        ?>
                    </td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Detail Kas Masuk</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -25px;">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="<?php echo site_url('kas_masuk/update_ar_item')?>" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" style="width: 97%;" name="vcCOAARItemCode" id="vcCOAARItemCode" required="required">
                                            ...
                                            <?php
                                            foreach ($akun as $ak) {
                                                if($ak->itCOACashBank == 0 && $ak->itCOAType == 1 && $ak->vcCOACode != $data_ar_header->vcCOACode){
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Detail Kas Masuk</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -25px;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?php echo site_url('kas_masuk/insert_ar_item')?>">
                <div class="modal-body">
                    <div class="form-group">
