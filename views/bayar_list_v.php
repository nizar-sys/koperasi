...
<thead>
	<tr>
		...
		<th data-options="field:'id_txt', width:'20',halign:'center', align:'center'">No. Transaksi</th>
		...
		<th data-options="field:'bunga', width:'15', halign:'center', align:'right'">Jasa Pinjaman <br> Angsuran</th>
...
<div id="tb" style="height: 35px;">
	...
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="false" onclick="cetak_laporan()">Cetak</a>
</div>
</div>
...
function cetak_laporan () {
		...
		var win = window.open('<?php echo site_url("bayar/cetak_laporan/?kode_transaksi=' + kode_transaksi + '&tgl_dari=' + tgl_dari + '&tgl_sampai=' + tgl_sampai + '"); ?>');
		if (win) {
			win.focus();
		} else {
