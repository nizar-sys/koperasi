	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<tr> 
				...
				// tipe bunga
				$options = array(
					'A'  => 'A: Persen Jasa Pinjaman dikali angsuran bln',
					'B'  => 'B: Persen Jasa Pinjaman dikali total pinjaman'
					//'C'  => 'C: Bunga Menurun = Persen Bunga dikali sisa pinjaman'
					);
				echo form_label('Tipe Jasa Pinjaman', 'pinjaman_bunga_tipe');
			...
			//dana cadangan 
				...
				echo form_label('Dana Cadangan Resiko (%)', 'dana_cadangan');
			...
			<tr>
				...
				echo form_label('Suku Jasa Pinjaman (%)', 'bg_pinjam');
				echo form_input($data);
				echo '
				</td>
				<td>';
			...
			echo form_label('Biaya Denda (%)', 'denda');
			echo form_input($data);
			echo '
				</td>
				<td>';
