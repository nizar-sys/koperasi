...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url().'assets/asset/images/favicon.ico'; ?>" type="image/x-icon" />
	...
	<header class="header">
		<a href="<?php echo site_url();?>" class="logo">
			<!-- Add the class icon to your logo image or logo icon to add the margining -->
			 <div style="text-align:center;"><img width="185" height="40" src="<?php echo base_url().'assets/asset/images/Arnawa_Apps Logo.png'; ?>"></div>
		</a>
