...
<head>
	<meta charset="UTF-8">
	<title><?php echo $this->load->get_section('judul_browser');?> - KOPKAR</title>
	...
	<header class="header">
		<a href="<?php echo site_url();?>" class="logo">
			<!-- Add the class icon to your logo image or logo icon to add the margining -->
			 <div style="text-align:center;"><img height="50" src="<?php echo base_url().'assets/asset/images/samudera_logo.png'; ?>"></div>
		</a>
