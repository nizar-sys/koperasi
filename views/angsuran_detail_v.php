				...
				<td>
					<table style="width:100%">
						...
						<tr>
							<td> ID Anggota</td>
							<td> : </td>
							<td> <?php echo 'A-'.sprintf('%04d', $data_anggota->id).' '.$data_anggota->identitas; ?></td>
						</tr>
						<tr>
							<td> Nama Anggota </td>
							<td> : </td>
...
<table  class="table table-bordered">
	<tr class="header_kolom">
		...
		<th style="width:15%; vertical-align: middle"> Angsuran Jasa Pinjaman</th>
