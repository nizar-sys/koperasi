...
class Pengeluaran_kas extends OperatorController {
	...
	public function pengeluaran_kas_accounting() {
		$this->data['judul_browser'] = 'Transaksi';
		$this->data['judul_utama'] = 'Transaksi';
		$this->data['judul_sub'] = 'Pengeluaran Kas Accounting';
		$this->data['isi'] = $this->load->view('pengeluaran_account_v', $this->data, TRUE);
		$this->load->view('themes/layout_utama_v', $this->data);
	...
	public function detail() {
		...
		$this->data['isi'] = $this->load->view('detail_pengeluaran_v', $this->data, TRUE);
		$this->load->view('themes/layout_utama_v', $this->data);
