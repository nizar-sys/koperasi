...
class Anggota extends OperatorController {
	...
	public function index() {
		...
		$crud->columns('file_pic','id_anggota','identitas','nama','nik','departement','tgl_daftar','jenis_anggota','masuk_kerja','alamat','notelp');
		$crud->fields('nama','identitas','jk','nik','departement', 'tmp_lahir','tgl_lahir','masuk_kerja','tgl_daftar','jenis_anggota','status','alamat','notelp','pass_word','aktif','file_pic');
		...
		$crud->display_as('masuk_kerja','Tanggal Masuk Kerja');
		$crud->display_as('jenis_anggota','Jenis Anggota');
		$crud->display_as('tgl_daftar','Tanggal Daftar Anggota');
		...
		$crud->required_fields('nama','identitas','tmp_lahir','tgl_lahir','masuk_kerja','jk','alamat','aktif');
		...
		// $crud->field_type('kepemilikan_rumah','dropdown',
		// 	array('Milik Sendiri' => 'Milik Sendiri','Sewa' => 'Sewa', 'Lainnya' => 'Lainnya'));
		// $crud->display_as('kepemilikan_rumah','Kepemilikan Rumah');

		// $crud->field_type('keanggotaan','dropdown',
		// 	array('Perorangan' => 'Perorangan','Kelompok' => 'Kelompok'));
		// $crud->display_as('keanggotaan','Keanggotaan');
		...
		$crud->display_as('status','Status Perkawinan');
	...
	function _kolom_id_cb ($value, $row) {
		$value = '<div style="text-align:center;">A-' . sprintf('%04d', $row->id) . '</div>';
		return $value;
	}
